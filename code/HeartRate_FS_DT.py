...
for i in range(len(list_of_lists)):
    ...
    '''    
    train_X = train_data.iloc[:, df.columns != 'heartrate_mean']
    train_y = train_data.iloc[:, df.columns == 'heartrate_mean'].values
    ...
    '''    
    test_X = test_data.iloc[:, df.columns != 'heartrate_mean']
    test_y = test_data.iloc[:, df.columns == 'heartrate_mean'].values
    ...
    '''    
    val_X = val_data.iloc[:, df.columns != 'heartrate_mean']
    val_y = val_data.iloc[:, df.columns == 'heartrate_mean'].values
