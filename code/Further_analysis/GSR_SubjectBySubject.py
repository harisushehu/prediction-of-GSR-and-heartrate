# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 21:29:10 2021
...
csvFileName = '../data/results_GSR_SubjectBySubject.csv'
...
for i in range(len(list_of_lists)):
    ...
    keras_callbacks   = [
          ...
          ModelCheckpoint("best_GSR_SS_model.hdf5", monitor='val_loss', save_best_only=True, mode='min', save_freq='epoch')]
    ...
    regressor = load_model('best_GSR_SS_model.hdf5')
    ...
    filename = "../data/GSR_SubjectBySubject/Pred_" + str(i)
