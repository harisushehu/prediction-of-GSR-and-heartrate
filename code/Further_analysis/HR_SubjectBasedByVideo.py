# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 15:22:11 2021

@author: harisushehu
"""

#Go to the project directory/path and run  /home/harisushehu/myenv/bin/python HR_SubjectBasedByVideo.py
...
csvFileName = '../data/results_HR_SubjectBasedByVideo.csv'
...
for i in range(len(list_of_lists)):
    ...
    keras_callbacks   = [
          ...
          ModelCheckpoint("best_HR_SV_model.hdf5", monitor='val_loss', save_best_only=True, mode='min', save_freq='epoch')]
    ...
    regressor = load_model('best_HR_SV_model.hdf5')
    ...
    for video_count in range(0, len(video_list)):
        ...
        filename = "../data/HR_SubjectByVideo/Pred_" + str(i) + "_" + str(video_count)
