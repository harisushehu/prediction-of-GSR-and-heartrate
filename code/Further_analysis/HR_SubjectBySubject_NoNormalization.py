# -*- coding: utf-8 -*-
"""
Created on Mon Apr 11 09:29:08 2022

@author: harisushehu
"""


#Go to the project directory/path and run  /home/harisushehu/myenv/bin/python HR_SubjectBySubject.py
...
csvFileName = '../data/results_HR_SubjectBySubject_NN.csv'
...
for i in range(len(list_of_lists)):
    ...
    X_train = train_data.iloc[:, train_data.columns != 'heartrate_mean']
    y_train = train_data.iloc[:, train_data.columns == 'heartrate_mean'].values
    ...
    X_test = test_data.iloc[:, test_data.columns != 'heartrate_mean']
    y_test = test_data.iloc[:, test_data.columns == 'heartrate_mean'].values
    ...
    X_val = val_data.iloc[:, val_data.columns != 'heartrate_mean']
    y_val = val_data.iloc[:, val_data.columns == 'heartrate_mean'].values
    ...
    keras_callbacks   = [
          ...
          ModelCheckpoint("best_HR_SS_NNmodel.hdf5", monitor='val_loss', save_best_only=True, mode='min', save_freq='epoch')]
    ...
    regressor = load_model('best_HR_SS_NNmodel.hdf5')
