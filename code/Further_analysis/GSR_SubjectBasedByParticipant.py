# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 20:53:06 2021

@author: harisushehu
"""

#Go to the project directory/path and run  /home/harisushehu/myenv/bin/python GSR_SubjectBasedByParticipant.py
...
csvFileName = '../data/results_GSR_SubjectBasedByParticipant.csv'
...
for i in range(len(list_of_lists)):
    ...
    keras_callbacks   = [
          ...
          ModelCheckpoint("best_GSR_SP_model.hdf5", monitor='val_loss', save_best_only=True, mode='min', save_freq='epoch')]
    ...
    regressor = load_model('best_GSR_SP_model.hdf5')
    ...
    for part_count in range(1, 154):
        ...
        if flag == True:
            ...
            filename = "../data/GSR_SubjectByParticipant/Pred_" + str(i) + "_" + str(part_count)
