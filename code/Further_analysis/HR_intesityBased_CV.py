# -*- coding: utf-8 -*-
"""
Created on Sun Oct 24 22:55:44 2021

@author: harisushehu
"""


#Go to the project directory/path and run  /home/harisushehu/myenv/bin/python HR_intesityBased_CV.py
...
csvFileName = './Graphs/results_HR_intensity_CV.csv'
...
for normloop in range(1, 154): #154
    ...
    if flag == True:
        ...
        valencePath = "/vol/grid-solar/sgeusers/harisushehu/EMAP/SessionInfo/P"  + participant_no + "-Session.csv"
...
for i in range(len(list_of_lists)):
    ...
    keras_callbacks   = [
          ...
          ModelCheckpoint("best_HR_intensity_model.hdf5", monitor='val_loss', save_best_only=True, mode='min', save_freq='epoch')]
    ...
    regressor = load_model('best_HR_intensity_model.hdf5')
    ...
    filename = "../data/HR_intensity/Pred_" + str(i)
